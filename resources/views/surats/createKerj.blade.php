...
<body onload="getComboN()">
  <form method="POST" action="{{ route('surats.storeKerj') }}" formtarget="_blank" target="_blank"  enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="input" class="form-control" name="pihak2" required>
      <br />
      <div>
      ...
      <div>
          ...
          <textarea name="pelaksanaanKj" id="pelaksanaanKj" rows="8" class="form-control" required></textarea>
      </div>
      <br/>
      <div>
          <b> Biaya-Biaya </b> <br/>
      ...
      <div>
          ...
          <textarea name="caraPembayaran" id="caraPembayaran" rows="8" class="form-control" required></textarea>
      </div>
      <br/>
      <div>
